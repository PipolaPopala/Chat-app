    ...
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
      <div className="w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0">
        ...
        <div>
          ...
          <input type="text" placeholder="Michael Jackson" className="w-full input input-bordered h-10" value={inputs.fullName}
        ...
        <div>
          ...
          <input type="text" placeholder="micjack" className="w-full input input-bordered h-10" value={inputs.username}
